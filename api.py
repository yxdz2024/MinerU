...
def mount_app_routes(app: FastAPI, run_mode: str = None):
    ...
    async def magic_pdf_parse_main(
        ...
        return await pdf_service.magic_pdf_parse_main(file, parse_method, lang_list=[lang])
    ...
    async def upload(
        ...
        return await pdf_service.magic_pdf_parse_main2(file=file,local_output_path=folder_path, lang_list=[lang])
